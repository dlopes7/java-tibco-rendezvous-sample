...
class PersonalData implements Serializable
{
    ...
    public PersonalData(String firstName, String lastName, int age, HashMap<String, String> headers) {
    ...
    public String toString() {
        return lastName+", "+firstName+" - "+age+" y.o." + "headers: " + headers.get("x-prioli");
    }
}
...
public class SendObject implements TibrvMsgCallback{
    ...
    public SendObject()
    {
        try
        {
            ...
            // GreetingController.oneAgentSdk.
            MessagingSystemInfo messagingSystemInfo = GreetingController.oneAgentSdk.createMessagingSystemInfo("TIBCO", queue.getName(), MessageDestinationType.QUEUE, ChannelType.IN_PROCESS, null);
            OutgoingMessageTracer outgoingMessageTracer = GreetingController.oneAgentSdk.traceOutgoingMessage(messagingSystemInfo);
            outgoingMessageTracer.start();
            HashMap<String, String> headers = new HashMap<String, String>();
            headers.put("x-prioli", outgoingMessageTracer.getDynatraceStringTag());

            try {
                PersonalData data = new PersonalData("John","Doe",25, headers);
    ...
    public void onMsg(TibrvListener listener, TibrvMsg msg)
    {
        ...
        PersonalData object = (PersonalData) getObject(msg,fieldName);
